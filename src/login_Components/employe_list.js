...
export default function Employe_list() {
  ...
  const handleDelete = (indexDelete) => {
    const updatedEmployees = employees.filter((employee, index) => index !== indexDelete);
      ...
      <Modal show={show}>
        <Card className="p-4 togl_card">
          ...
          <div className='d-flex justify-content-end'>
            <Button className="Submit_button btn btn-outline-primary" variant='light' type="submit">Cancel</Button>
                        ...
                        .map((employee, index) => (
                            <tr key={index}>
                              ...
                              <td>
                                ...
                                <button className='me-2 border-0 bg-transparent' onClick={() => handleDelete(index)}>
                                  <MdDeleteForever />
                                </button>
                              </td>
                            </tr>
