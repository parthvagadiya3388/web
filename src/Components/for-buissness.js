                  ...
                  <Col md={6}>
                    <Form.Group className="mb-3">
                      ...
                      <InputGroup>
                        ...
                        <Form.Control className="radius" type="text" placeholder="Enter your name" id="name" value={formik.values.name} onChange={formik.handleChange} />
                      </InputGroup>
                  ...
                  <Col md={6}>
                    <Form.Group className="mb-3">
                      ...
                      <InputGroup>
                        ...
                        <Form.Control className="radius" type="text" placeholder="Enter your position" id="position" value={formik.values.position} onChange={formik.handleChange} />
                      </InputGroup>
                  ...
                  <Col md={6}>
                    <Form.Group className="mb-3">
                      ...
                      <InputGroup>
                        ...
                        <Form.Control className="radius" type="password" placeholder="Enter your password" id="password" value={formik.values.password} onChange={formik.handleChange} />
                      </InputGroup>
                  ...
                  <Col md={6}>
                    <Form.Group className="mb-3">
                      ...
                      <InputGroup>
                        ...
                        <Form.Control className="radius" type="password" placeholder="Confirm your password" id="confirmPassword" value={formik.values.confirmPassword} onChange={formik.handleChange} />
                      </InputGroup>
